        ...
        <View style={LearnSelectScreenStyles.boxContainer}>
          <View style={LearnSelectScreenStyles.rows}>
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate("LampVideosScreen", {
                  lamp: "SunBell Smart",
                });
              }}
            >
            ...
            <TouchableOpacity
              style={LearnSelectScreenStyles.lampContainer}
              onPress={() =>
                navigation.navigate("LampVideosScreen", { lamp: "SunTurtle" })
              }
            >
          ...
          <View style={LearnSelectScreenStyles.rows}>
            <TouchableOpacity
              style={LearnSelectScreenStyles.lampContainer}
              onPress={() =>
                navigation.navigate("LampVideosScreen", { lamp: "Move Smart" })
              }
            >
            ...
            <TouchableOpacity
              style={LearnSelectScreenStyles.lampContainer}
              onPress={() =>
                navigation.navigate("LampVideosScreen", { lamp: "Start+" })
              }
            >
